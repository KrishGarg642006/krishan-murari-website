    ...
    <section className="about-section">
      ...
      <div className="about-content">
        <div className="about-text">
          ...
          <p>
            Established in 2002 by our esteemed Managing Director, Mrs. Manav Garg, Aggarwal Feeds has been a trusted name in cattle nutrition across Punjab. We specialize in manufacturing high-quality cotton seed oil cake, de-oiled cake, and advanced cattle feed solutions.
          </p>
          
          <h3>Our Expertise</h3>
          <p>
            We offer two specialized types of cattle feed:
          </p>
          <ul>
            <li>
